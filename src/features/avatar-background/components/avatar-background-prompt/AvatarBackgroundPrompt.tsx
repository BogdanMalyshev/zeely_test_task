...
export const AvatarBackgroundPrompt = () => {
  ...
  const regenerateButtonClasses = "inline-flex h-[34px] items-center gap-1 rounded-[10px] py-[7px] pl-[7px] pr-3 text-[12px] font-semibold text-black transition-colors hover:bg-gray-light";
